...
const NavbarAdmin: React.FC = () => {
  ...
  return (
    <div
      className={`flex w-full bg-primary-darker lg:pr-16 h-full items-center justify-end `}>
      <ul
        className={`flex text-xl lg:gap-6 font-semibold text-secondary-lighter items-center gap-24 md:gap-1 xl:gap-5`}>
        <li>
