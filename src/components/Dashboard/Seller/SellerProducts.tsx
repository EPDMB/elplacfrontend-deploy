...
import { formTypeEnum, IProduct, ProductProps } from "@/types";
        ...
        <div className="bg-secondary-lighter flex flex-col items-center lg:h-[100vh] col-span-8 sm:col-span-7">
                    ...
                    <div
                      ...
                      {notification.product && (
                        <div>
                          ...
                          <p>ID Solicitud: {notification.product.pRequestId}</p>
                  ...
                  <td className="px-6 py-4">
                    <input
                      ...
                      onChange={(e: ChangeEvent<HTMLInputElement>) =>
                        handleInputChange(product.id, "size", e.target.value)
                      }
                      placeholder="Talle"
          ...
          <div className="flex justify-end mt-4 flex-col items-end">
            ...
            <button
              ...
              className="disabled:cursor-not-allowed bg-primary-darker mt-5 text-white p-2 rounded hover:bg-primary-dark md:h-8 flex items-center justify-center md:w-36 md:text-base text-xs sm:text-sm">
              Enviar Productos
            </button>
          </div>
        </div>
