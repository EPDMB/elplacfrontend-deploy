...
const ProfileLeftFilters: React.FC<IProfileLeftFilters> = ({
  ...
  return (
    <div className="mt-2 sm:mt-0 ml-1 sm:ml-0 sm:gap-3 sm:p-4 xl:pt-10 text-primary-darker">
      <div className=" flex  items-center gap-3 mb-2 xl:gap-4 xl:mb-5 ">
      ...
      <div className="w-full h-auto flex flex-row items-center  sm:items-center gap-1 xl:gap-3 mb-2 xl:mb-5">
